...
class ComparableWithMatrixTest extends TestCase
{
    ...
    public function testIsEqualExpectsSuccess() {
        $this->runComparable(__FUNCTION__, ColumnVector::fill(3, $this->first), Matrix::fill(3, 3, $this->second), 0.0);
    }
    public function testIsNotEqualExpectsSuccess() {
        $this->runComparable(__FUNCTION__, ColumnVector::fill(3, $this->first), Matrix::fill(3, 3, $this->second), 1.0);
    }
