...
class CollectionTest extends TestCase
{
    ...
    {
        $columnVector = Matrix::fillRandomizeRequireFrom(3, 3, 1.0, 10.0)->min();
        $is_minimized = true;
        foreach ($columnVector->data as $value) {
            if ($value < 1.0) {
                $is_minimized = false;
    ...
    {
        $matrix = Matrix::fillRandomizeRequireFrom(3, 3, 0.1, 10.0)->lowerRange(1.0);
    ...
    {
        $matrix = Matrix::fillRandomizeRequireTo(3, 3, 1.0, 10.1)->upperRange(10.0);
