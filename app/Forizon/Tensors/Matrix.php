...
class Matrix implements Matrixable, Tensor
{
    ...
    public function asColumnVector(int $index = 0): ColumnVector
    {
        return new ColumnVector(array_column($this->data, $index));
    }

    public function asRowVector(int $index = 0): RowVector
    {
    ...
    {
        return $this->map(fn ($value) => -$value);
    }
