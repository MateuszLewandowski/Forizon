...
abstract class Vector
{
    ...
    final public function shape(): array
    {
     ...
     * Factories
     */
    abstract public static function create(mixed $data, bool $skip = false): RowVector|ColumnVector;

    abstract public static function fastCreate(mixed $data, bool $skip = true): RowVector|ColumnVector;

    abstract public static function fillZeros(int $length): RowVector|ColumnVector;

    abstract public static function fillOnes(int $length): RowVector|ColumnVector;

    abstract public static function fill(int $length, float $value): RowVector|ColumnVector;

    abstract public static function fillRandomize(int $length, int $from = 1, int $to = 1, int $precision = 2): RowVector|ColumnVector;

    abstract public static function fillRandmax(int $length): RowVector|ColumnVector;

    abstract public static function fillRandom(int $length): RowVector|ColumnVector;

    abstract public static function fillUniform(int $length): RowVector|ColumnVector;

    abstract public static function fillGaussian(int $length): RowVector|ColumnVector;

    final protected static function randmax(int $length): array
    {
        if ($length < 2) {
    ...
    final protected static function random(int $length): array
    {
        if ($length < 2) {
            throw new InvalidArgumentException('', Response::HTTP_BAD_REQUEST);
        }
    ...
    final protected static function uniform(int $length): array
    {
        if ($length < 2) {
            throw new InvalidArgumentException('', Response::HTTP_BAD_REQUEST);
        }
    ...
    final protected static function gaussian(int $length): array
    {
        if ($length < 2) {
            throw new InvalidArgumentException('', Response::HTTP_BAD_REQUEST);
        }
    ...
    final protected static function randomize(int $length, int $from = -1, int $to = 1, int $precision = 2): array
    {
        if ($length < 2) {
            throw new InvalidArgumentException('', Response::HTTP_BAD_REQUEST);
        }
     ...
     */
    final public static function randomizeRequireFrom(int $length, float $from = -1.0, float $to = 1.0, float $precision = 2): array
    {
        try {
     ...
     * @throws InvalidArgumentException
     */
    final public static function randomizeRequireTo(int $length, float $from = -1.0, float $to = 1.0, float $precision = 2): array
    {
        try {
            $data = self::randomize($length, $from, $to, $precision);
            $i = mt_rand(0, $length);
